...
public class SyncsCreateNewSyncOperationRequestSync {
 ...
 public enum SyncIntervalUnitEnum {
  ...
  public SyncsCreateNewSyncOperationRequestSync() {
  }

  public SyncsCreateNewSyncOperationRequestSync sourceId(Integer sourceId) {
  ...
  **/
  ...
  public SyncsCreateNewSyncOperationRequestSync destinationId(Integer destinationId) {
  ...
  **/
  ...
  public SyncsCreateNewSyncOperationRequestSync modelId(Integer modelId) {
  ...
  **/
  ...
  public SyncsCreateNewSyncOperationRequestSync scheduleType(ScheduleTypeEnum scheduleType) {
  ...
  **/
  ...
  public SyncsCreateNewSyncOperationRequestSync _configuration(Map<String, Object> _configuration) {
  ...
  public SyncsCreateNewSyncOperationRequestSync putConfigurationItem(String key, Object _configurationItem) {
  ...
  **/
  ...
  public SyncsCreateNewSyncOperationRequestSync streamName(String streamName) {
  ...
  **/
  ...
  public SyncsCreateNewSyncOperationRequestSync syncMode(SyncModeEnum syncMode) {
  ...
  **/
  ...
  public SyncsCreateNewSyncOperationRequestSync syncInterval(Integer syncInterval) {
  ...
  **/
  ...
  public SyncsCreateNewSyncOperationRequestSync syncIntervalUnit(SyncIntervalUnitEnum syncIntervalUnit) {
  ...
  **/
   ...
   * @return the SyncsCreateNewSyncOperationRequestSync instance itself
   */
  public SyncsCreateNewSyncOperationRequestSync putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SyncsCreateNewSyncOperationRequestSync syncsCreateNewSyncOperationRequestSync = (SyncsCreateNewSyncOperationRequestSync) o;
    return Objects.equals(this.sourceId, syncsCreateNewSyncOperationRequestSync.sourceId) &&
        Objects.equals(this.destinationId, syncsCreateNewSyncOperationRequestSync.destinationId) &&
        Objects.equals(this.modelId, syncsCreateNewSyncOperationRequestSync.modelId) &&
        Objects.equals(this.scheduleType, syncsCreateNewSyncOperationRequestSync.scheduleType) &&
        Objects.equals(this._configuration, syncsCreateNewSyncOperationRequestSync._configuration) &&
        Objects.equals(this.streamName, syncsCreateNewSyncOperationRequestSync.streamName) &&
        Objects.equals(this.syncMode, syncsCreateNewSyncOperationRequestSync.syncMode) &&
        Objects.equals(this.syncInterval, syncsCreateNewSyncOperationRequestSync.syncInterval) &&
        Objects.equals(this.syncIntervalUnit, syncsCreateNewSyncOperationRequestSync.syncIntervalUnit)&&
        Objects.equals(this.additionalProperties, syncsCreateNewSyncOperationRequestSync.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SyncsCreateNewSyncOperationRequestSync {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("sync_mode");
    openapiRequiredFields.add("sync_interval");
    openapiRequiredFields.add("sync_interval_unit");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SyncsCreateNewSyncOperationRequestSync
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SyncsCreateNewSyncOperationRequestSync.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SyncsCreateNewSyncOperationRequestSync is not found in the empty JSON string", SyncsCreateNewSyncOperationRequestSync.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SyncsCreateNewSyncOperationRequestSync.openapiRequiredFields) {
      ...
      if (!jsonObj.get("sync_mode").isJsonPrimitive()) {
      ...
      if (!jsonObj.get("sync_interval_unit").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SyncsCreateNewSyncOperationRequestSync.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SyncsCreateNewSyncOperationRequestSync' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SyncsCreateNewSyncOperationRequestSync> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SyncsCreateNewSyncOperationRequestSync.class));

       return (TypeAdapter<T>) new TypeAdapter<SyncsCreateNewSyncOperationRequestSync>() {
           @Override
           public void write(JsonWriter out, SyncsCreateNewSyncOperationRequestSync value) throws IOException {
           ...
           @Override
           public SyncsCreateNewSyncOperationRequestSync read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SyncsCreateNewSyncOperationRequestSync instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SyncsCreateNewSyncOperationRequestSync given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SyncsCreateNewSyncOperationRequestSync
  * @throws IOException if the JSON string is invalid with respect to SyncsCreateNewSyncOperationRequestSync
  */
  public static SyncsCreateNewSyncOperationRequestSync fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SyncsCreateNewSyncOperationRequestSync.class);
  }

 /**
  * Convert an instance of SyncsCreateNewSyncOperationRequestSync to an JSON string
  *
  * @return JSON string
  */
